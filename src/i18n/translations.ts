 ...
 ja: {
    ...
    brands: {
      redLabo: {
        ...
        description: 'RED LABOは私たちの前衛的イノベーション拠点であり、AI統合型音響映像インタラクティブ製品を開発し、テクノロジーと創造的表現の関係性を再構築しています。RED LABOの製品は、音、映像、人工知能の境界をなくすことを目指しています。',
      },
      bitVibe: {
        name: 'BitVibe',
        tagline: 'プロフェッショナルギア',
        description: 'BitVibeはプレミアムセカンダリーラインとして、信頼性とパフォーマンスに優れた完成度の高いオーディオ周辺機器を提供します。スタジオクラスのスピーカー、MIDIキーボードからプロフェッショナルDJ機器まで、BitVibeは精度と使いやすさを兼ね備えたツールでクリエイターをサポートします。',
      },
    },
    products: {
      title: '製品エコシステム',
